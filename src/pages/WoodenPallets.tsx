  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content={`Premium wooden pallets, boxes & industrial packaging by ${COMPANY_NAME} in Greater Noida. ISPM 15 compliant, custom sizes, 1T+ load capacity. Durable & reusable solutions for shipping and storage.`}
        />
        <meta
          name="keywords"
          content="wooden pallets, wooden boxes, industrial packaging, timber pallets, custom wooden crates, ISPM 15 pallets, heavy-duty packaging, TNR Solutions, Greater Noida packaging, reusable pallets, press wood pallets, edge protectors"
        />
        ...
        <meta
          ...
          content="Premium wooden pallets, boxes, and industrial packaging solutions built for strength and reliability. ISPM 15 compliant, custom sizes available."
        />
        ...
        <meta
          ...
          content="Premium wooden pallets, boxes & industrial packaging — ISPM 15 compliant, custom sizes, 1T+ capacity."
        />
